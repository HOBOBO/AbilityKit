...
public sealed class LeaveRoomRequestHandler : ITcpGatewayRequestHandler
{
    ...
    public LeaveRoomRequestHandler(IClusterClient clusterClient, IOptions<TcpGatewayOptions> options, ITcpGatewaySessionRegistry registry)
    {
    ...
    public bool CanHandle(uint opCode) => opCode == _options.Value.LeaveRoomOpCode;
