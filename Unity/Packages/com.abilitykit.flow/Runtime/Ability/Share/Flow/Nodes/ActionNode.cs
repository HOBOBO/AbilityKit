...
namespace AbilityKit.Ability.Flow.Nodes
{
    public sealed class ActionNode : IFlowNode
    {
        ...
        public ActionNode(Action<FlowContext> onEnter = null, Func<FlowContext, float, FlowStatus> onTick = null, Action<FlowContext> onExit = null, Action<FlowContext> onInterrupt = null)
        {
            _onEnter = onEnter;
            _onTick = onTick;
            _onExit = onExit;
