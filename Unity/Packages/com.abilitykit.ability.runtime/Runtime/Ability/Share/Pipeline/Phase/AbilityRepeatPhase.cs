...
namespace AbilityKit.Ability
{
    ...
    /// 重复阶段 - 重复执行子阶段指定次数
    /// </summary>
    public class AbilityRepeatPhase : AbilityDurationalPhaseBase
    {
        /// <summary>
        /// 重复次数（-1表示无限）
        /// </summary>
        ...
        /// 要重复执行的阶段
        /// </summary>
        private IAbilityPipelinePhase _repeatPhase;
        
        /// <summary>
        /// 要重复执行的动作
        /// </summary>
        private Action<IAbilityPipelineContext, int> _repeatAction;
        
        /// <summary>
        /// 当前正在执行的子阶段
        /// </summary>
        private IAbilityPipelinePhase _currentSubPhase;
        ...
        /// 设置要重复的阶段
        /// </summary>
        public AbilityRepeatPhase SetRepeatPhase(IAbilityPipelinePhase phase)
        {
            _repeatPhase = phase;
            _repeatAction = null;
            return this;
        ...
        /// 设置要重复的动作
        /// </summary>
        public AbilityRepeatPhase SetRepeatAction(Action<IAbilityPipelineContext, int> action)
        {
        ...
        private void ExecuteRepeat(IAbilityPipelineContext context)
        {
            // 检查是否达到重复次数
        ...
        private void OnRepeatComplete(IAbilityPipelineContext context)
        {
            CurrentRepeatIndex++;
        ...
        /// 创建重复阶段
        /// </summary>
        public static AbilityRepeatPhase Create(int repeatCount = -1)
        {
            return new AbilityRepeatPhase(repeatCount);
        }

        /// <summary>
        /// 创建重复阶段（带动作）
        /// </summary>
        public static AbilityRepeatPhase Create(Action<IAbilityPipelineContext, int> action, int repeatCount = -1, float interval = 0f)
        {
            var phase = new AbilityRepeatPhase(repeatCount);
