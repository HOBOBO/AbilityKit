...
namespace AbilityKit.Demo.Moba.Services.Projectile
{
    public sealed class MobaProjectileEventSnapshotService_Obsolete : IService
    {
        ...
        public MobaProjectileEventSnapshotService_Obsolete(AbilityKit.Demo.Moba.Services.MobaGamePhaseService phase, IProjectileService projectiles, MobaProjectileLinkService links)
        {
