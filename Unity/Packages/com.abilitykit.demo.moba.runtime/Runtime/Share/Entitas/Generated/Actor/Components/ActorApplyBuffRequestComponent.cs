...
public partial class ActorEntity {
    ...
    public AbilityKit.Ability.Share.Impl.Moba.Components.ApplyBuffRequestComponent applyBuffRequest { get { return (AbilityKit.Ability.Share.Impl.Moba.Components.ApplyBuffRequestComponent)GetComponent(ActorComponentsLookup.ApplyBuffRequest); } }
    ...
    public void AddApplyBuffRequest(int newBuffId, int newSourceId, int newDurationOverrideMs, long newParentContextId, int newOriginSourceActorId, int newOriginTargetActorId) {
        ...
        var component = (AbilityKit.Ability.Share.Impl.Moba.Components.ApplyBuffRequestComponent)CreateComponent(index, typeof(AbilityKit.Ability.Share.Impl.Moba.Components.ApplyBuffRequestComponent));
