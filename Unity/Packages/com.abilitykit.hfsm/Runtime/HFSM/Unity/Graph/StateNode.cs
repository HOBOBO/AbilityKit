...
namespace AbilityKit.HFSM.Graph
{
    ...
    public class StateNode : NodeBase
    {
        ...
        [SerializeField]
        private List<BehaviorItem> _behaviorItems = new List<BehaviorItem>();
        ...
        /// </summary>
        public IReadOnlyList<BehaviorItem> BehaviorItems => _behaviorItems;

        /// <summary>
        /// Access to behavior items list for editor and serialization
        /// </summary>
        public List<BehaviorItem> BehaviorItemsInternal => _behaviorItems;
        ...
        public StateNode()
        {
            ...
            _nodeType = GraphNodeType.State;
        }

        public StateNode(string displayName) : base(displayName, GraphNodeType.State)
        {
        }
        ...
        /// </summary>
        public BehaviorItem GetBehaviorItem(string id)
        {
        ...
        /// </summary>
        public void AddBehaviorItem(BehaviorItem item)
        {
            if (item == null)
                return;
        ...
        /// </summary>
        public void InitializeBehaviorItems(List<BehaviorItem> items)
        {
            _behaviorItems = items ?? new List<BehaviorItem>();
        }
        ...
        /// </summary>
        public List<BehaviorItem> GetRootBehaviorItems()
        {
        ...
        /// </summary>
        public List<BehaviorItem> GetBehaviorChildren(string parentId)
        {
            var parent = GetBehaviorItem(parentId);
            if (parent == null)
                return new List<BehaviorItem>();
        ...
        public override bool Validate()
        {
            ...
            {
                Log.LogError($"StateNode with ID {Id} has an empty display name.");
                return false;
            }
            return true;
        }
