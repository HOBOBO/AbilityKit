...
namespace AbilityKit.BehaviorTree.Editor
{
    ...
    public sealed class AuthoringCreateWizard : EditorWindow
    {
        ...
        private void OnGUI()
        {
            ...
            _project = (AuthoringProjectAsset?)EditorGUILayout.ObjectField(
                "注册到项目（可选）", _project, typeof(AuthoringProjectAsset), false);
        ...
        private void Create(Func<AuthoringSourceDocument> buildTemplate)
        {
            ...
            if (_openGraph) AuthoringGraphWindow.Open(asset);
            Close();
        }
