...
{
    /// <summary>Legacy bridge for prefixed parent nodes.</summary>
    [System.Obsolete("Use AbilityKit.BehaviorTree.Nodes.ParentNodeBase.", false)]
    public abstract class BtParentNodeBase : AbilityKit.BehaviorTree.Nodes.ParentNodeBase
    {
