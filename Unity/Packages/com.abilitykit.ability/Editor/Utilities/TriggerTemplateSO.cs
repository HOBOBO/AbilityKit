...
namespace AbilityKit.Ability.Editor
{
    public sealed class TriggerTemplateSO : ScriptableObject
    {
        ...
        public Dictionary<string, ArgRuntimeEntryCore> BuildDefaultBindings()
        {
            var dict = new Dictionary<string, ArgRuntimeEntryCore>(StringComparer.Ordinal);
    ...
    public sealed class TemplateParamDef
    {
        ...
        public ArgRuntimeEntryCore DefaultValue = new ArgRuntimeEntryCore();
    }
