...
namespace AbilityKit.Modifiers
{
    ...
    public struct ModifierResult
    {
        ...
        /// </summary>
        public float FinalValue => OverrideFlag != 0 ? OverrideValue : (BaseValue + AddSum) * MulProduct;
        ...
        public static ModifierResult WithAddMul(float baseValue, float addSum, float mulProduct, int count = 1)
            => new()
            {
                BaseValue = baseValue,
                AddSum = addSum,
        ...
        public override string ToString()
        {
            ...
            return $"({BaseValue:F2} + {AddSum:F2}) × {MulProduct:F2} = {FinalValue:F2}";
        }
