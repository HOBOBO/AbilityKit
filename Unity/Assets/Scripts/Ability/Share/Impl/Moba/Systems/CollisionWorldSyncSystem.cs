...
namespace AbilityKit.Ability.Share.Impl.Moba.Systems
{
    ...
    public sealed class CollisionWorldSyncSystem : WorldSystemBase
    {
        ...
        public CollisionWorldSyncSystem(global::Contexts contexts, IWorldServices services)
            : base(contexts, services)
        {
            ...
            _world = svc.World;
            _withShape = contexts.actor.GetGroup(global::ActorMatcher.AllOf(
                global::ActorComponentsLookup.Transform,
                global::ActorComponentsLookup.Collider));
            _withCollisionId = contexts.actor.GetGroup(ActorMatcher.CollisionId);
        }
