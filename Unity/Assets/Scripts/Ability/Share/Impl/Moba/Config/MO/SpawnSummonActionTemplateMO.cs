...
namespace AbilityKit.Ability.Impl.BattleDemo.Moba.Config.MO
{
    public sealed class SpawnSummonActionTemplateMO
    {
        ...
        public SpawnSummonActionTemplateMO(global::AbilityKit.Ability.Impl.BattleDemo.Moba.Config.SpawnSummonActionTemplateDTO dto)
        {
    ...
    public sealed class PresentationTemplateMO
    {
        ...
        public PresentationTemplateMO(global::AbilityKit.Ability.Impl.BattleDemo.Moba.Config.PresentationTemplateDTO dto)
        {
            if (dto == null) throw new ArgumentNullException(nameof(dto));
