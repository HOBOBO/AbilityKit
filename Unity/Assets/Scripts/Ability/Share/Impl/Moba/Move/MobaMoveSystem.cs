...
namespace AbilityKit.Ability.Share.Impl.Moba.Move
{
    public sealed class MobaMoveSystem : global::Entitas.IExecuteSystem
    {
        ...
        public MobaMoveSystem(global::Contexts contexts, MobaLobbyStateService lobby, MobaMoveService moves, IWorldClock clock)
        {
            ...
            _group = _contexts.actor.GetGroup(ActorMatcher.AllOf(ActorComponentsLookup.ActorId, ActorComponentsLookup.Transform));
        }
