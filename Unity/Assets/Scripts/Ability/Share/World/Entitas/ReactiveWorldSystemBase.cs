...
namespace AbilityKit.Ability.World.Entitas
{
    public abstract class ReactiveWorldSystemBase<TEntity> : WorldSystemBase where TEntity : class, IEntity
    {
        ...
        protected ReactiveWorldSystemBase(global::Contexts contexts, IWorldServices services)
            : base(contexts, services)
        {
        }

        protected abstract IGroup<TEntity> CreateGroup(global::Contexts contexts);
