...
namespace AbilityKit.Editor.GamplayTag
{
    internal sealed class GameplayTagTextPrompt : EditorWindow
    {
        ...
        public static void Open(string title, string label, string defaultText, Action<string> onOk)
        {
            Open(title, label, defaultText, multiline: false, onOk: onOk);
        }

        public static void Open(string title, string label, string defaultText, bool multiline, Action<string> onOk)
        {
