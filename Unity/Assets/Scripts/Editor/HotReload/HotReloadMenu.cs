...
namespace AbilityKit.Game.Editor.HotReload
{
    public static class HotReloadMenu
    {
        ...
        private sealed class EntryWithLogger : IHotfixEntry
        {
            ...
            public void Install(global::Contexts contexts, global::Entitas.Systems systems, AbilityKit.Ability.World.DI.IWorldServices services)
            {
            ...
            public void Uninstall(global::Contexts contexts, global::Entitas.Systems systems, AbilityKit.Ability.World.DI.IWorldServices services)
            {
